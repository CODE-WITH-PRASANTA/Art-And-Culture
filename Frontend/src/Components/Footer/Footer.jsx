  ...
  return (
    <footer className="footer">
          ...
          <div className="footer-columns">
            ...
            <div className="footer-column footer-brand-column">
              ...
              <div className="footer-contact">
                <div className="footer-contact-item">
                  <span>📍</span>
                  <p>92, Mansi Vihar, Sanjay Nagar Sector 23, Ghaziabad 201002</p>
                </div>
                <div className="footer-contact-item">
                  <span>📧</span>
                  <p>artandculturehub@gmail.com</p>
                </div>
                <div className="footer-contact-item">
                  <span>📞</span>
                  <p>+91-7302577395 / +91 80765 52275</p>
                </div>
              </div>
            </div>
            ...
            <div className="footer-column">
              ...
              <ul className="footer-category-list">
                <li><span>›</span> God Murtis</li>
                <li><span>›</span> Pooja Items</li>
                <li><span>›</span> Brass Idols</li>
                <li><span>›</span> Handicraft</li>
                <li><span>›</span> Temple Decor</li>
                <li><span>›</span> Spiritual Jewelry</li>
              </ul>
            </div>
            ...
            <div className="footer-column">
              ...
              <div className="map-box">
                {/* Updated Google Maps iframe query pointing precisely to 92, Mansi Vihar, Sanjay Nagar Sector 23, Ghaziabad 201002 */}
                <iframe
                  src="https://maps.google.com/maps?q=92%2C%20Mansi%20Vihar%2C%20Sanjay%20Nagar%20Sector%2023%2C%20Ghaziabad%20201002&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  loading="lazy"
                  title="Store Location Map - 92 Mansi Vihar Sanjay Nagar Ghaziabad"
                ></iframe>
              </div>
      ...
      <div className="footer-bottom">
        <p>© 2025 Art & Culture. Crafted with tradition & spirituality.</p>
        <div className="footer-links">
          <Link to="/privacypolicy" onClick={scrollTop}>Privacy Policy</Link>
          <Link to="/termandcondition" onClick={scrollTop}>Terms & Conditions</Link>
          <Link to="/shipping" onClick={scrollTop}>Shipping Policy</Link>
          <Link to="/returns" onClick={scrollTop}>Returns & Refund</Link>
        </div>
      </div>
