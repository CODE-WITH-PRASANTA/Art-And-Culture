...
const SAMPLE_PRODUCTS = [
  {
    id: "01",
    title: "Girls Mint Green & Off-White Solid Open",
    subtitle: "Graphic Print Men & Women Footwear",
    rate: 24.0,
    qty: 2,
    color: "#D9F7EE",
  },
  {
    ...
    subtitle: "32.5mm (1.28 Inch) TFT Color Touch Display",
    rate: 160.0,
    qty: 1,
    color: "#E9E9EE",
  },
  {
    ...
    subtitle: "Graphic Print Men & Women Fashion",
    rate: 244.99,
    qty: 3,
    color: "#FFF4D9",
  },
...
const CheckOutSection = () => {
  ...
  const subTotal = useMemo(
    () => products.reduce((sum, p) => sum + p.rate * p.qty, 0),
    [products]
  );
  ...
  const NoticeBar = () => (
    <div className="checkoutsection-notice" role="region" aria-label="Promotions">
      <div className="checkoutsection-notice-inner">
        <div className="checkoutsection-notice-text">
          Save Up To <strong>30% To 40%</strong> Off! Just Look At The{" "}
          <strong>Great Deals!</strong>
        </div>

        <button
          className="checkoutsection-notice-close"
          onClick={() => alert("Notice dismissed (demo)")}
  ...
  const CheckoutSummary = () => (
    <div className="checkoutsection-animate-fade">
      ...
      <div className="checkoutsection-card checkoutsection-products">
        ...
        <div
          className="checkoutsection-table-wrap"
          role="region"
          aria-label="Products table (scrollable)"
        >
          <table className="checkoutsection-table" role="table" aria-label="Order items">
            <thead>
              <tr>
                ...
                <tr key={p.id} className="checkoutsection-hover-row">
                  <td className="col-product">
                    <div className="checkoutsection-prod">
                      <div
                        className="checkoutsection-thumb"
                      ...
                      <div className="checkoutsection-prod-meta">
                        <div className="checkoutsection-prod-title">
                          {p.title}
                        </div>
                        <div className="checkoutsection-prod-sub">
                          {p.subtitle}
                        </div>
                      </div>
                    </div>
      ...
      <div className="checkoutsection-address-grid">
        <div className="checkoutsection-address-card" role="article" aria-label="Home address">
          <div className="checkoutsection-address-title">HOME ADDRESS</div>
          <div className="checkoutsection-address-name">
            Witney Blessington
          </div>
          <div className="checkoutsection-address-line">
            144 Cavendish Avenue, Indianapolis, IN 46251
          </div>
          <div className="checkoutsection-address-phone">+1 234 567 890</div>
        </div>

        <div className="checkoutsection-address-card" role="article" aria-label="Office address">
          ...
          <div className="checkoutsection-address-line">
            2971 Westheimer Road, Santa Ana, IL 80214
          </div>
  ...
  const PaymentSelection = () => (
    <div className="checkoutsection-animate-slide">
      ...
      <div className="checkoutsection-card checkoutsection-payment-tabs">
        {/* Tabs */}
        <div className="checkoutsection-tabs" role="tablist" aria-label="Payment">
          <button
          ...
          >
            <span className="tab-icon">P</span> Paypal
          </button>
          ...
          >
            <span className="tab-icon">💳</span> Credit/Debit
          </button>
          ...
          >
            <span className="tab-icon">💵</span> Cash on Delivery
          </button>
        </div>
        ...
        <div className="checkoutsection-form-grid">
          ...
          <input
            name="firstName"
            className="checkoutsection-input"
            value={buyer.firstName}
            onChange={handleChange}
            placeholder="Enter First Name"
            aria-label="Buyers First Name"
          />
          ...
          {paymentMethod === "paypal" && (
            <div className="checkoutsection-radio-row">
              <div>
                <div className="checkoutsection-label">
                  Select your PayPal account type
                </div>

                <label className="checkoutsection-radio">
                  <input type="radio" name="paypal_type" defaultChecked /> Domestic
                </label>

                <label className="checkoutsection-radio">
                  <input type="radio" name="paypal_type" /> International
                </label>
              </div>

              <div className="checkoutsection-login-row">
                <button
                  className="checkoutsection-btn checkoutsection-primary"
                  onClick={() => alert("Login to Paypal (demo)")}
                >
          ...
          {paymentMethod === "cod" && (
            <div
              className="checkoutsection-card"
              style={{ marginTop: 16, background: "#f4f7f9" }}
            >
              <p>
                You have selected <strong>Cash on Delivery</strong>. Payment will be
          ...
          <div className="checkoutsection-actions">
            <button
              className="checkoutsection-btn checkoutsection-back"
  ...
  const Sidebar = () => (
    <aside className="checkoutsection-sidebar" aria-labelledby="order-summary">
      <div className="checkoutsection-card checkoutsection-promo">
        ...
        <div className="checkoutsection-promo-form">
          ...
          <button
            className="checkoutsection-apply checkoutsection-btn"
            onClick={togglePromo}
          >
            Apply
          </button>
      ...
      <div className="checkoutsection-card checkoutsection-summary">
        <div className="checkoutsection-summary-title" id="order-summary">
          Order Summary
        </div>

        <div className="checkoutsection-summary-body">
          <div className="checkoutsection-summary-row">
            <span>Sub Total :</span>
          ...
          <div className="checkoutsection-summary-row">
            <span>
              Discount <em>({promoApplied ? promo : "-"})</em>:
            </span>
        ...
        <div className="checkoutsection-summary-total">
          <span>Total (USD) :</span>
      ...
      {step === "summary" && (
        <div className="checkoutsection-actions">
          <button
            className="checkoutsection-btn checkoutsection-back"
            onClick={() => alert("Back to cart (demo)")}
          >
            Back To Cart <FiChevronRight className="icon-right" />
          </button>
          ...
          >
            Continue Payment <FaRegCreditCard className="icon-right" />
          </button>
        </div>
      )}
    </aside>
